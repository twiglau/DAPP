...
// const _priceContractAddress='0x879C903F4A0C23150EF4dDaf6ED66e1aD5cc467d';
// const _recordContractAddress = "0x2E81d2158D02aA814c2870a1E8452d507893C08B";
// const _tokensContractAddress = "0x6b505cF4Adb99053E5232E1F47Ddc29400841D1e";
// const _contractAddress = "0x19BB4D6D585216600AAdA851c6480329F24A4E43";
const _priceContractAddress='0x1cCaAd8B503b4254B07145202BB1B774E8e24fD1';
const _recordContractAddress = "0x7F922D81c3aeAdfAf3B7814D49677515f7Ca2768";
const _tokensContractAddress = "0x7a9F6C46940eCFB45042CBd0322AefB206B9D7b5";
const _contractAddress = "0x137945747d1ecf93f603C3227315202aB80a0B2a";
...
const btcContractAddress = '0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c';
const usdtContractAddress = '0x55d398326f99059ff775485246999027b3197955';
const filContractAddress = '0x0d8ce2a99bb6e3b7db580ed848240e4a0f9ae153';
const libraContractAddress = '0x0983c8b3bc8028c6615da3c0b533e45e88ecf8fc';
//new
const adaContractAddress = '0x3ee2200efb3400fabb9aacf31297cbdd1d435d47';
const xrpContractAddress = '0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe';
const dogeContractAddress = '0xba2ae424d960c26247dd6c32edc70b295c744c43';
const dotContractAddress = '0x7083609fce4d1d8dc0c979aab8c869ea2c873402';
const solContractAddress = '0x0';
const uniContractAddress = '0xbf5140a22578168fd562dccf235e5d43a02ce9b1';
const bchContractAddress = '0x8ff795a6f4d97e7887c79bea79aba5cc76444adf';
const ltcContractAddress = '0x4338665cbb7b2485a8855a139b75d5e34ab0db94';
const linkContractAddress = '0xf8a0bf9cf54bb92f17374d9e9a321e6a111a51bd';
const eosContractAddress = '0x56b6fb708fc5732dec1afc8d8556423a2edccbd6';
const diemContractAddress = '0x2bbea8d7daa10e98a46eea252cc465dafe737dfc';
/////////////////////////////////////////////////////////////////////////////币安主网 - end
...
//激活
function activate(account,upperAddress,callback,errorCallback){
    if (upperAddress == undefined || upperAddress == null || upperAddress==""){
        alert("No parent address")
        return;
    }
    getContract(_contractABI, _contractAddress,(contract)=>{
        const data = contract.methods.activate(
            upperAddress,
        ).encodeABI();
...
function balanceOf(currency,address,callback,errorCallback) {
    //授权
    currency = currency.toUpperCase();
    getContract(_tokenContractABI, _tokensContractAddress,(contract)=>{
        contract.methods.balanceOf(getCurrencyIndex(currency),address)
            .call()
            .then((res) => {
...
function exchange(currency,upperAddress,account,amount,callback,errorCallback){
    ...
    getContract(_contractABI, _contractAddress,(contract)=>{
        const data = contract.methods.exchange(
                ...
                Math.trunc(Number(amount)*systemPrecisions)
            ).encodeABI();
        sendTransfer(account, data, 0x0, callback, errorCallback)
    });
}
//兑换记录
function exchangeRecord(address,index,callback,errorCallback) {
    getContract(_contractABI, _contractAddress,(contract)=>{
        contract.methods.exchangeMap(address,index)
            .call()
            .then((res) => {
                callback(res);
            })
...
function queryExchangeRecordSize(address,callback,errorCallback) {
    getContract(_contractABI, _contractAddress,(contract)=>{
        contract.methods.exchangeRecordSize(address)
            .call()
            .then((res) => {
                callback(res);
            })
...
function depositOneBnb(upperAddress,account,currency,amount,callback,errorCallback){
    let value = '0x'+Math.trunc((Number(amount)*Number("1000000000000000000"))).toString(16);
    getContract(_contractABI, _contractAddress,(contract)=>{
        const data = contract.methods
            .depositOne(
                upperAddress,
    ...
    if(currency2.toUpperCase() == 'BNB'){
        ...
        getContract(_contractABI, _contractAddress,(contract)=>{
            const data = contract.methods
                .depositTwo(
                    upperAddress,
                    Math.trunc(Number(_amount1)*systemPrecisions),
...
function depositTwoBnb(upperAddress,account,_amount1,currency2,callback,errorCallback){
    let value = '0x'+Math.trunc((Number(_amount1)*Number("1000000000000000000"))).toString(16);
    getContract(_contractABI, _contractAddress,(contract)=>{
        const data = contract.methods
            .depositTwo(
                upperAddress,
...
function takeoutTwo(account,amount1,currency2,callback, errorCallback){
    ...
    getContract(_contractABI, _contractAddress,(contract)=>{
        const data = contract.methods
            .takeoutTwo(
                Math.trunc(Number(amount1)*systemPrecisions),
                getCurrencyIndex(currency2),
            ).encodeABI();
        sendTransfer(account, data, 0x0, callback, errorCallback);
    });
...
function getContract(abi, address,callback) {
    try{
        let _contract = new window.web3.eth.Contract(abi, address);
        callback(_contract);
    }catch (e) {
        initWallet((res)=>{
            console.log("初始化钱包");
