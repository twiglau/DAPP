...
export const l = {
  ...
  fmd_op1: "领取奖励",
  fmd_op2: "退出：领取奖励 & 解押",
  error_tips_unconnect: "请打开钱包，并连接您的账户！",
  error_tips_num0: "您必须输入一个大于0的数字！",
  more_than_deposit: "赎回数量大于已存入的数量！",
  error_tips_claim: "您还没有可领取的奖励！",
  error_tips_trans: "您还没有可转换的代币！",
  ok_tips_deposit: "存入成功！",
  ok_tips_withdraw: "赎回成功！",
  ok_tips_claim: "领取奖励成功！",
  ok_tips_claim_exit: "退出：领取奖励 & 解押",
  notmainnet_title: "警告",
  notmainnet_tips: "您当前浏览的数据不是来自于主网络，请切换您的钱包到主网络！",
  no_main_tips: "网络错误，请确认您连接的是 BNB mainnet!",
  no_metamask_tips: "您还没有安装MetaMask钱包插件！",
  no_dapp_liulanqi:'您需要安装Dapp浏览器!',
  no_signin_liu:'您需要重新连接,登录',
  no_approved_success:'成功',
  no_approved_failed:'失败',
  no_approved_success_tip:'授权成功,请继续操作!',
  no_approved_failed_tip:'授权失败',
  ...
  l_invite:'邀请',
  l_fee:'手续费',
  l_fee_tip1:'存入时间 >30天,赎回需要扣除手续费 2%',
  l_fee_tip2:'存入时间 <=30天,赎回需要扣除手续费 5%',
  t_holdfen:'持币分红',
  t_shangfan:'上级返利',
  t_ganen:'感恩奖励',
  t_quanqiu:'全球分红',
  ...
  inactiveUpper:'未激活',
  active_a:'激活账户',
  active_address:'请输入邀请地址[激活]',
  active_ple_address:'邀请地址',
  l_uppper:'您注册的上级地址为 ',
  l_bindActive:'绑定激活成功',
  l_edubuzu:'授权额度不足,需要重新授权',
}