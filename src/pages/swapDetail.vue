                ...
                <ul class="pools__rows">
                  <li class="pools__row-1">
                    <div class="pools__logo-name">
                      <svg-icon  class="pools__coin-logo" :icon-class="item.fromToken + '_coin'" />
                      <div class="pools__coin-name">{{item.fromToken}}</div>
                    </div>
                    <svg-icon icon-class="enter_icon"></svg-icon>
                    <div class="pools__logo-name">
                      <svg-icon class="pools__coin-logo" :icon-class="item.toToken + '_coin'" />
                      <div class="pools__coin-name">{{item.toToken}}</div>
                    </div>
                  </li>
                  <li class="pools__row pools__apy">
                    <div class="pools__labe-field">{{$t('l.t_transamount')}}</div>
                    <div class="pools__label-value pools__label-value--black">{{item.fromAmount + ' / ' + item.toAmount}}</div>
                  </li>
                  <li class="pools__row">
...
<script>
import {queryExchangeRecords} from '@/utils/api'
...
export default {
  ...
  methods: {
    ...
    async queryRecords(){
      ...
      const res = await queryExchangeRecords({pageNo,pageSize,address})
